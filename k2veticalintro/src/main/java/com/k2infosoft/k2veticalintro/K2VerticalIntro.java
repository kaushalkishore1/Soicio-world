...
/**
 * Created by hp pavilion on 27-11-2016.
 */

public abstract class K2VerticalIntro extends AppCompatActivity {
    static final String TAG = "K2VerticalIntro";
    private static final double SCROLL_DURATION_FACTOR_ON_SCROLL = 2;
    ...
    private List<K2VerticalIntroItem> verticalIntroItemList = new ArrayList<>();
    private K2VerticalViewPager verticalViewPager;
    ...
    private ViewPager.SimpleOnPageChangeListener pageChangeListener = new ViewPager.SimpleOnPageChangeListener() {
        ...
        public void onPageSelected(final int position) {
            ...
            Utils.setUpRecentAppStyle(K2VerticalIntro.this, verticalIntroItemList.get(position).getBackgroundColor());
    ...
    private void setUpViewPager() {
        if (hasCustomFont()) {
            for (K2VerticalIntroItem k2VerticalIntroItem : verticalIntroItemList) {
                k2VerticalIntroItem.setCustomTypeFace(customTypeFace);
            }
        }
        K2VerticalIntroPagerAdapter pagerAdapter =
                new K2VerticalIntroPagerAdapter(getSupportFragmentManager(), verticalIntroItemList);
    ...
    private void findAndSetupViews() {
        ...
        verticalViewPager = (K2VerticalViewPager) findViewById(R.id.vertical_view_pager);
    ...
    protected void addIntroItem(K2VerticalIntroItem k2VerticalIntroItem) {
        verticalIntroItemList.add(k2VerticalIntroItem);
    }
